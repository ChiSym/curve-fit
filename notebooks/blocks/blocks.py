...
class CurveFit:
    ...
    def __init__(
        ...
        *,
        ...
        @genjax.static_gen_fn
        def inlier_model(y, inlier_sigma):
            return genjax.normal(y, inlier_sigma) @ 'value'

        @genjax.static_gen_fn
        def outlier_model(_y, _inlier_sigma):
    ...
    def importance_sample(
        ...
        choose_ys = genjax.choice_map(
            {"ys": genjax.vector_choice_map(genjax.choice_map({("y", "value"): ys}))}
        )
